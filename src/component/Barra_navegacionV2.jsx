...
function Barra_navegacionV2({ruta}) {
  ...
  const activarDeclaracion =()=>{
   enrutador('./DeclaracionProposito');
  }
  const activarContexto =()=>{
    enrutador('./DiagramaContexto');
  }
  const activarListaAcontecimiento =()=>{
    enrutador('./ListaAcontecimiento');
  }
  const activarDFDxNiveles =()=>{
    enrutador('./DFDxNiveles');
  }
  ...
  return (
    <div>
      ...
      <div className='z-10 flex bg-bg-barraNavegacion p-5 items-center fixed w-full bg-[#1C1C1C]' >
        ...
        <h1 className="text-[32px] text-white ml-6 inria-serif-bold">
          FullStock
        </h1>
        ...
        <div className='w-full  flex flex-row place-content-end pr-44'>
          <h1 className=' text-[24px] text-[#A0A0A0] px-10 group inria-serif-bold'>
            Inventario
            <div className='absolute bg-[#151515] hidden group-hover:block p-10 '>
              <span className=" ">
                  <h1 className='text-[24px] text-[#6EAAB7] inria-serif-bold'>Sistema de Inventario</h1>
                  ...
                  <div className='flex flex-row pl-6 py-2 group'>
                    ...
                    <h1 className='text-[16px] text-[#ffffff] inria-serif-bold px-2 hover:text-[#4871AF] cursor-pointer'>Declaración de propósitos</h1>
                  </div>
                  <div className='flex flex-row pl-6 py-2 group'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h1 className='text-[16px] text-[#ffffff] inria-serif-bold px-2 hover:text-[#4871AF] cursor-pointer'>Diagrama de contexto</h1>
                  </div>
                  ...
                  <div className='flex flex-row pl-6 py-2 group'>
                    ...
                    <h1 className='text-[16px] text-[#ffffff] inria-serif-bold px-2 hover:text-[#4871AF] cursor-pointer'>Lista de Acontecimientos</h1>
                  </div>
                  ...
                  <div className='flex flex-row pl-6 py-2 group'>
                    ...
                    <h1 className='text-[16px] text-[#ffffff] inria-serif-bold px-2 hover:text-[#4871AF] cursor-pointer'>DFD x Niveles</h1>
                  </div>
                  <div className='flex flex-row pl-6 py-2 group'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className='flex flex-row pl-6 py-2 group'>
                    ...
                    <h1 className='text-[16px] text-[#ffffff] inria-serif-bold px-2 hover:text-[#4871AF] cursor-pointer'>Diccionario de datos</h1>
                  </div>
          ...
          <h1 className=" text-[24px] text-[#A0A0A0] px-10 inria-serif-bold">
            Compras
          </h1>
          <h1 className=" text-[24px] text-[#A0A0A0] px-10 inria-serif-bold">
            RRHH
