...
const Problem4 = () => {
  return (
    <div className='w-full bg-[#0A192E] flex pb-40 place-content-center'>
        <div className='  w-[60%]'>
            <h1 className='text-white text-[24px] p-2'>4. Propósito del estudio</h1>
            <hr className=' border-gray-50 py-5'/>



            <h1 className="text-[32px] text-[#31D0C7] pl-3">4.1. Análisis de la Experiencia del Cliente:</h1>
            <h1 className='text-[#B1BACC] text-[20px] p-6 bg-[#172945] mb-14'>
            ...
            <h1 className="text-[32px] text-[#31D0C7] pl-3">4.2. Gestión de Inventario:</h1>
            <h1 className='text-[#B1BACC] text-[20px] p-6 bg-[#172945] mb-14'>
            ...
            <h1 className="text-[32px] text-[#31D0C7] pl-3">4.3. Eficiencia Operativa:</h1>
            <h1 className='text-[#B1BACC] text-[20px] p-6 bg-[#172945] mb-14'>
